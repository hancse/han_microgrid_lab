...
#save_data = pd.DataFrame(columns = ['PV','EV','Bat_SOC','Grid night tariff','Grid day tariff'])
                                    
s_data = [network.generators_t['p']['PV panel'],network.loads_t['p']['House Loads'],Bat_SOC
          ,network.storage_units_t.state_of_charge['Grid_night']
          ,network.storage_units_t.state_of_charge['Grid_day']]
